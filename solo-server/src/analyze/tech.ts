...
function buildSectors(tech: TechDetection, fileTree: string[]): TechSector[] {
  ...
  sectors.push(
    ...
    },
    {
      ...
      providers: [
        { id: 'seo-p1', name: 'Sol OS Built-in', description: 'Auto SEO audit & fix', price: 'Included', recommended: true, tier: 'balanced' },
    ...
    },
    {
      ...
      providers: [
        { id: 'aeo-p1', name: 'Sol OS Built-in', description: 'AEO audit & recommendations', price: 'Included', recommended: true, tier: 'balanced' },
